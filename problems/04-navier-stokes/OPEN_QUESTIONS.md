...
| 2 | quelle classe minimale de solutions anciennes adaptées admet un théorème de Liouville sans supposer `L∞_tL³_x` ? | trois stratégies distinctes montrent que l'énergie seule ne ferme ni queue, ni trace, ni module critique; le pivot obligatoire vise maintenant la rigidité | classe limite sourcée d'un premier blow-up, puis théorème de trivialité ou solution ancienne adverse |
