...
|---:|---|---|---|
| 1 | une intermittence angulaire d'amplitude non bornée peut-elle maintenir la masse critique faible-`L^(3/2)` et log-BMO tout en satisfaisant `div omega=0`, Biot–Savart et un résidu Navier–Stokes sous-critique ? | le cycle 0024 extrait un axe et ferme les multicœurs dès qu'une amplitude critique uniforme et une masse par bloc sont disponibles; le contre-profil sparse montre exactement où cette borne est perdue | profil solénoïdal reproductible avec queues et résidu suivis, ou inégalité coercive remplaçant `Phi<=M` par une hypothèse critique héritée |
