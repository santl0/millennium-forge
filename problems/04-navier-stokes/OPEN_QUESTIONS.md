...
| 2 | peut-on contrôler uniformément les queues de `R_iR_j(u_i u_j)` dans une extraction de profil à énergie seulement locale ? | pression = première perte non locale de compacité–rigidité | lemme de commutateur critique ou contre-suite à deux paquets |
