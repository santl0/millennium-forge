...
|---:|---|---|---|
| 1 | une cascade multicoeur peut-elle maintenir une masse critique par coquille et une direction globale log-BMO sans admettre de sélection d'axe à erreur et variation sublinéaires ? | les cycles 0022–0023 excluent l'axe fixe puis l'axe mobile lent; l'intermittence et l'absence d'axe canonique sont les échappatoires restantes | construction divergence-free avec budget d'occupation angulaire et résidu suivi, ou inégalité multiaxe coercive |
