...
| 2 | peut-on obtenir la compacité forte du produit quadratique et de la pression proche sans supposer la borne globale `L³` qui ferme déjà ESS/GKP ? | le cycle 0003 montre que `L³` contrôle automatiquement la queue distante en `A^-3`, tandis que l'énergie seule échoue | contre-suite oscillante/concentrée pour la pression proche, puis extraction des hypothèses minimales de compacité |
